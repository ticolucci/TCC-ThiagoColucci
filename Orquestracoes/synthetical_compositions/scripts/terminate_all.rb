...
def terminate_all ec2
  ...
  response["reservationSet"]["item"].each do |reservation_item|
...
#p ec2.run_instances(:image_id => "ami-3ac33653", :min_count => 1, :max_count => 1, :key_name => KEY_NAME, :instance_type => "t1.micro")
